...
static inline void render_block() {
    ...
    static const float step_seq_seq1_gates[8] = { 1.f, 1.f, 1.f, 1.f, 0.f, 0.f, 0.f, 0.f };
    {
        ...
        if (_ri > 0.5f && step_seq_seq1_prev_rst <= 0.5f) {
            step_seq_seq1_step = 0;
        } else if (_ci > 0.5f && step_seq_seq1_prev_clk <= 0.5f) {
    ...
    float karplus_kp1_out;
    {
        float _freq = fmaxf(50.f, fminf(2000.f, step_seq_seq1_cv));
        float _fb = 0.99f;
        float _damping = 0.5f;
